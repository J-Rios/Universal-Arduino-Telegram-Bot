...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (strcmp(bot.messages[i].type, "callback_query") == 0) {
      ...
      if (strcmp(text, "/options") == 0) {
        static char keyboardJson[] = "[[{ \"text\" : \"Go to Google\", \"url\" : \"https://www.google.com\" }],[{ \"text\" : \"Send\", \"callback_data\" : \"This was sent by inline\" }]]";
      ...
      if (strcmp(text, "/start") == 0) {
        ...
        sprintf(welcome, 
          ...
          "This is Inline Keyboard Markup example.\n"
          "\n"
          "/options : returns the inline keyboard\n"
        , from_name);
